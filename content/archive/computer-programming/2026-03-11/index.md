...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin: 20px 0;">
  <div style="text-align: center;">
    <a href="warcraft-back.jpg" target="_blank">
      <img src="warcraft-back.jpg" alt="Warcraft III: The Frozen Throne - Back Cover" style="width: 10rem; border: 1px solid #ccc; border-radius: 4px;">
    </a>
    <p><em>Warcraft III: The Frozen Throne — Back Cover</em></p>
  </div>
  <div style="text-align: center;">
    <a href="warcraft-front.jpg" target="_blank">
      <img src="warcraft-front.jpg" alt="Warcraft III: The Frozen Throne - Front Cover" style="width: 10rem; border: 1px solid #ccc; border-radius: 4px;">
    </a>
    <p><em>Warcraft III: The Frozen Throne — Front Cover</em></p>
  </div>
  <div style="text-align: center;">
    <a href="civ-3-back.jpg" target="_blank">
      <img src="civ-3-back.jpg" alt="Sid Meier's Civilization III - Back Cover" style="width: 10rem; border: 1px solid #ccc; border-radius: 4px;">
    </a>
    <p><em>Sid Meier's Civilization III — Back Cover</em></p>
  </div>
  <div style="text-align: center;">
    <a href="civ-3-front.jpg" target="_blank">
      <img src="civ-3-front.jpg" alt="Sid Meier's Civilization III - Front Cover" style="width: 10rem; border: 1px solid #ccc; border-radius: 4px;">
    </a>
    <p><em>Sid Meier's Civilization III — Front Cover</em></p>
  </div>
  <div style="text-align: center;">
    <a href="jumpstart-back.jpg" target="_blank">
      <img src="jumpstart-back.jpg" alt="JumpStart - Back Cover" style="width: 10rem; border: 1px solid #ccc; border-radius: 4px;">
    </a>
    <p><em>JumpStart — Back Cover</em></p>
  </div>
  <div style="text-align: center;">
    <a href="jumpstart-front.jpg" target="_blank">
      <img src="jumpstart-front.jpg" alt="JumpStart - Front Cover" style="width: 10rem; border: 1px solid #ccc; border-radius: 4px;">
    </a>
    <p><em>JumpStart — Front Cover</em></p>
  </div>
</div>
