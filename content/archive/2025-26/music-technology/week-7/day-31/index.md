...
{{< button text="Bach — Brandenburg Menuetto" >}}Bach-Brandenburg-Menuetto.mid{{< /button >}}

{{< button text="Tchaikovsky — Sugar Plum" >}}Tchaikovsky-Sugar-Plum.mid{{< /button >}}

### Step 2 — Import Both into GarageBand

1. Open a **new GarageBand project**.
2. Drag the first MIDI file from your Downloads folder into the GarageBand timeline. GarageBand will create a Software Instrument track automatically.
