---
title: "Day 30: Final Presentations & Share"
date: 2026-05-01
description: "Present your finished game to the class and share your Scratch project publicly."
day_number: 30
units:
...
- [**MS-CS-FCP.4.5**](/scratch/description/#ms-cs-fcp4) — Implement a simple algorithm in a computer program — students showcase a working Scratch prototype that demonstrates the algorithms powering their game's core mechanic.
- [**MS-CS-FCP.4.6**](/scratch/description/#ms-cs-fcp4) — Develop an event-driven program — students present and demo a Scratch project built around events that respond to player input.
- [**MS-CS-FCP.6.4**](/scratch/description/#ms-cs-fcp6) — Develop a program for creative expression which may have visual, audible, and/or tactile results — students share an original game they designed and built for a real audience.
