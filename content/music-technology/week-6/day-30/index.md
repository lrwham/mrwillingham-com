---
title: "Day 30: Finish Your 32-Bar Melody"
date: 2026-05-01T08:32:28-04:00
description: "Complete your 32-bar (AABA) melody project in GarageBand or MuseScore, then export it as an MP3 and submit to the CTLS discussion post."
day_number: 30
units:
  - "Music Reading"
  - "Beat Making"
...
{{< icon "calendar" >}} **Friday, May 1st, 2026**
...
| Measures | Section | Role |
|---|---|---|
| **1–8** | 🟦 **A** | Main idea — your chord progression and main melody |
| **9–16** | 🟦 **A** | Repeat of the main idea |
| **17–24** | 🟩 **B** | Bridge — contrasting chords, sound, or feel |
| **25–32** | 🟦 **A** | Return of the main idea |
...
Go to [Hooktheory](https://www.hooktheory.com/theorytab) and search for a song you like. Click on the song to see its chord progression listed below the sheet music. Use those chords as the basis for your project.
...
| Section | What to do |
|---|---|
| **A sections** | Use your main drum loop or pattern |
| **B section** | Change something — swap to a different loop, add a fill, thin out the drums, or use a different style |
...
- [ ] **Chords** — 32 measures of chords following AABA form. Chords come from the chord progressions ZIP or from [Hooktheory](https://www.hooktheory.com/theorytab).
...
- [**MSMTC8.CR.1**](/music-technology/description/#msmtc8cr1) — Generate musical ideas for various purposes and contexts (creating an original melody and drum pattern in AABA form).
- [**MSMTC8.CR.2**](/music-technology/description/#msmtc8cr2) — Select and develop musical ideas for defined purposes and contexts (choosing chord progressions and developing them into a complete 32-bar composition).
- [**MSMTC8.CR.3**](/music-technology/description/#msmtc8cr3) — Evaluate and refine selected musical ideas to create musical work that meets appropriate criteria (listening back, fixing pitch and timing issues, and ensuring AABA form is clear before exporting).
- [**MSMTC8.CR.4**](/music-technology/description/#msmtc8cr4) — Share creative musical work that conveys intent, demonstrates craftsmanship, and exhibits originality (exporting and submitting a finished MP3 that demonstrates AABA form with chords, drums, and original melody).
