---
title: "Day 36: Filmmaking BrainPOP & Project Work"
date: 2026-05-11T08:00:00-04:00
description: "Complete the Filmmaking BrainPOP (Movie + Quiz in Graded Mode), then work quietly on your assigned part of the film scoring project."
day_number: 36
units:
  - "Film Scoring"
standards:
...
{{< icon "calendar" >}} **Monday, May 11th, 2026**
...
Log in through Clever if you need to get to BrainPOP.
...
{{< button text="Video Files" >}}https://cobbk12org-my.sharepoint.com/:f:/g/personal/lawton_willingham_cobbk12_org/IgDK5ty5emk8QKaKG8qRTpvVAdlFZbCLtp2_Js2UIwnEnIE?e=DFSCT6{{< /button >}}

{{< button text="Sound Effects and Foley" >}}https://cobbk12org-my.sharepoint.com/:f:/g/personal/lawton_willingham_cobbk12_org/IgCIuItu193vSKtt0ZkcZkrwAUqbC_07p4x5Qx9PX5Rnf2U?e=a9ho1h{{< /button >}}
...
|---|---|---|
| Tuesday 5/12 | 6th Grade Field Day | Work session — some classes won't meet |
| Wednesday 5/13 | 7th Grade Field Day | Work session — some classes won't meet |
| Thursday 5/14 | 8th Grade Field Day | **No classes** |
| Friday 5/15 | Submission Day | **Your part is due — submit on CTLS** |
...
- [**MSMTC8.CN.1**](/music-technology/description/#msmtc8cn1) — Synthesize and relate knowledge and personal experiences to make music (connecting knowledge of filmmaking conventions — from the BrainPOP — to the choices made when scoring picture with music and sound effects).
- [**MSMTC8.CR.1**](/music-technology/description/#msmtc8cr1) — Generate musical ideas for various purposes and contexts (selecting and placing Apple Loops that reflect the emotional tone and action of the student's assigned film segment).
- [**MSMTC8.CR.2**](/music-technology/description/#msmtc8cr2) — Select and develop musical ideas for defined purposes and contexts (developing a cohesive musical and SFX track for a specific, defined portion of the film).
- [**MSMTC8.CR.3**](/music-technology/description/#msmtc8cr3) — Evaluate and refine selected musical ideas to create musical work that meets appropriate criteria (listening back and adjusting loop and SFX placement to stay in sync with the picture and meet project requirements).
