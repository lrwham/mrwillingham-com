...
1. Connect the audio interface to the computer using the **USB cable**.
1. Turn the **gain knob** to an appropriate level (remember your sound check from Wednesday).
1. Position the microphone about **6 inches from your mouth**.
1. Open **GarageBand** and create a new empty project with an **audio track**.

### Recording

1. **Record Intro A** — Read your first intro clearly and confidently.
1. Stop recording. Create a **new audio track** for the second intro.
1. **Record Intro B** — Read your second intro the same way.
1. **Listen back** to both recordings. Which one sounds better? Which topic are you more excited about?
...
1. **Split** — Place the playhead where you want to cut, then use **Edit → Split Regions at Playhead** (or press ⌘T) to split a recording into two pieces. Delete the part you don't want.
1. **Delete** — Select a region and press the **Delete** key to remove it.
