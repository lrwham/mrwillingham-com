---
title: "Day 40 - Podcast Publish"
date: 2026-03-11
description: "Podcast Unit: Finish editing, export your podcast as an MP3, and submit your final episode."
day_number: 40
units: ["Podcast"]
tags: ["editing", "exporting", "Soundtrap", "MP3"]
resources: ["Soundtrap"]
toc: false
---
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
  <figure style="border: 2px solid #ccc; padding: 1rem;">
    <img src="export-menu.png" alt="File menu with Export highlighted">
    <figcaption>Go to File → Export.</figcaption>
  </figure>
  <figure style="border: 2px solid #ccc; padding: 1rem;">
    <img src="export-audio-mastering.png" alt="Export dialog showing Audio selected and Mastering on">
    <figcaption>Make sure Audio is selected and Mastering is turned on.</figcaption>
  </figure>
  <figure style="border: 2px solid #ccc; padding: 1rem;">
    <img src="export-mp3.png" alt="MP3 download option">
