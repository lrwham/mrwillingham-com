...
1. Turn the **gain knob** to an appropriate level.
1. Position the microphone about **6 inches from your mouth**.
1. Open **GarageBand** and create a new empty project.
1. Import your **intro music** file from OneDrive onto its own track.
1. Add a new **audio track** for your voice recording.
