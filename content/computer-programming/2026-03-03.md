...
Welcome back from break! Today we're using a new platform called **EduBlocks** to write and run Python code right in your browser.
...
| "Enter an animal: "             | `animal`       | Any animal                        |
...
of {animal} soup. After lunch, everyone started {verb_ing} for
...
1. **Add 2-3 more inputs** to make the story longer and funnier.
2. **Write your own original story template** using at least 8 variables. Be creative — it can be about anything.
3. **Stretch:** Can you figure out how to add a blank line between sentences using `print("")`? Format your story so it looks clean in the output.
...
Today you learned how to use `input()` and variables together to build an interactive program. These are the same fundamental concepts you've been using in Minecraft — variables store data, and your program uses that data to do something. The difference is that now the _user_ gets to decide what goes into the variables while the program is running.
